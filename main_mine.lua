...
opt = {
  ...
  saveIter = 99,    -- write check point on this interval
  ...
  mean = {0,0,0},
  data_root = '/projectnb/dlearn/jcliff/videogan/DATA/',
  data_list = '/projectnb/dlearn/jcliff/videogan/DATA/jobs_list.txt',
}
